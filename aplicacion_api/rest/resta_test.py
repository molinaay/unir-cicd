...
class Resta_Tests(unittest.TestCase):
    ...
    def test_Resta_Respuesta_Correcta(self):
        self.primerNumero=6
        self.segundoNumero=3
        self.url=f"{BASE_URL}reste?primerNumero={self.primerNumero}&segundoNumero={self.segundoNumero}"
    ...
    def test_Resta_Parametro_Incorrecto(self):      
        try:
         self.primerNumero=6
