...
class Suma_Tests(unittest.TestCase):
    ...
    def test_Suma_Respuesta_Correcta(self):
        self.primerNumero=6
        self.segundoNumero=3
        self.url=f"{BASE_URL}sume?primerNumero={self.primerNumero}&segundoNumero={self.segundoNumero}"
    ...
    def test_Suma_Parametro_Incorrecto(self):      
        try:
         self.primerNumero=6
