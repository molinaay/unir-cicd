...
class Resta_Tests(unittest.TestCase):
    def setUp(self):
    ...
    def test_Resta_Con_Dos_Numeros_Positivos_Resultado(self):
        self.primerNumero=5
        self.segundoNumero=3
        self.resultadoEsperado=2
        self.resultadoObtenido=self.calculadora.Reste(self.primerNumero,
                                                     self.segundoNumero)
        self.assertEqual(self.resultadoEsperado,self.resultadoObtenido)

    def test_Resta_Con_Dos_Numeros_Negativos_Resultado(self):
        self.primerNumero=-2
        self.segundoNumero=-3
    ...
    def test_Resta_Con_Numero_Positivo_Y_Negativo_Resultado(self):
        self.primerNumero=2
        self.segundoNumero=-3
    ...
    def test_Parametro_No_Es_Valido(self):
        ...
        with self.assertRaises(TypeError) as contexto:
            self.calculadora.Reste(self.primerNumero, self.segundoNumero)
